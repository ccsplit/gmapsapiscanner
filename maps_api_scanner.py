...
if response.status_code == 200:
    ...
    print("Reason: " + response.content.decode("utf-8"))
...
if response.status_code == 200:
    print(
        "API key is vulnerable for Streetview API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.status_code == 200:
    print(
        "API key is vulnerable for Embed API! Here is the PoC HTML code which can be used directly via browser:"
    )
    print(
...
if response.text.find("error_message") < 0:
    print(
        "API key is vulnerable for Directions API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error_message") < 0:
    print(
        "API key is vulnerable for Distance Matrix API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error_message") < 0:
    print(
        "API key is vulnerable for Find Place From Text API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error_message") < 0:
    print(
        "API key is vulnerable for Autocomplete API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error_message") < 0:
    print(
        "API key is vulnerable for Elevation API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("errorMessage") < 0:
    print(
        "API key is vulnerable for Timezone API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error") < 0:
    print(
        "API key is vulnerable for Roads API! Here is the PoC link which can be used directly via browser:"
    )
    print(url)
else:
...
if response.text.find("error") < 0:
    ...
    print(
        "curl -i -s -k  -X $'POST' -H $'Host: www.googleapis.com' -H $'Content-Length: 22' --data-binary $'{\"considerIp\": \"true\"}' $'"
        + url
        + "'"
    )
else:
